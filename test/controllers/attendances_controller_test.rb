...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post attendances_url, params: { attendance: { employee_id: @attendance.employee_id, state: @attendance.state } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { employee_id: @attendance.employee_id, state: @attendance.state } }
